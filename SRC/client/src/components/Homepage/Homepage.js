...
export default function Homepage() {
	...
	useEffect(() => {
		// Call getGames with "01" to load Week 1 games by default
		getGames("01");
	...
	// Check selection of the week and then call getGames to display
	function showGames() {
	...
	async function predictGame(hTeam) {
		...
		if (prediction > 0) {
			...
			document
				.getElementById("predictionList")
				.appendChild(document.createTextNode("OUR PREDICTION: THIS GAME COULD GO ETHIER WAY"));
		}
	...
	return (
		<div>
			...
			<div>
				<center>
					<br />
					<span style={{ fontSize: "60px", fontFamily: "Impact" }}>BET 3309</span>
					<br />
				</center>
				<br />
				<Favorites />
